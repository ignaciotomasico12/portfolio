...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Primary: #00ffc3 -> (0, 255/255, 195/255)
      // Secondary: #25afb1 -> (37/255, 175/255, 177/255)
      // We can add a couple of slight variations if we want, or stick to these two.
      
      const palette = [
          { r: 0, g: 1, b: 0.76 },       // Primary
          { r: 0.14, g: 0.68, b: 0.69 }, // Secondary
      ];
